...
const intereses = ref([
    ...
    'Deportes al Aire Libre: Práctico Basquet y Handaball, y hago gimnasio 3 dias a la semana, actividades que practico regularmente para mantener un equilibrio entre el trabajo y la vida personal.',
    ...
    'Administrador de Producción Agrícola y Ganadera: Trabajo todo lo que es hacienda y al consumo y comercializo en la exportación de frutas y verduras, y a Provincias.'
]);
</script>
