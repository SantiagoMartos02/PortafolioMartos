...
import { ref } from 'vue';
const titulo = 'Desarrollador Back-End';
const fecha = 'Desde Junio 2023 / Septiembre 2024';
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Lideré un equipo de 4 desarrolladores en la creación de una plataforma de servicio de maquinaria solar que incrementó las ventas en un 40% durante el primer medio año.' },
    { id: 2, src: icono2, parrafo: 'Diseñamos y desarrollamos una aplicaciones Mobile utilizando Fluter.' },
    { id: 3, src: icono3, parrafo: 'Implementamos soluciones de autenticación y autorización, mejorando la seguridad del sitio mobile y reduciendo los intentos de acceso no autorizado en un 30%.' },
    { id: 4, src: icono4, parrafo: 'Colaboramos con diseñadores de UX/UI para crear interfaces de usuario atractivas y fáciles de usar, aumentando la satisfacción del cliente en un 30%.' },
    { id: 5, src: icono5, parrafo: 'Automatizamos procesos de despliegue continuo, reduciendo los tiempos de despliegue en un 40%.' },
]);
</script>
