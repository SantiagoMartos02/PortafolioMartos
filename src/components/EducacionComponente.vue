...
const educacion = ref([
  ...
  {fecha: '2023', title: 'Curso de React', descripcion: 'Creé un contador que aumente o disminuya cuando se hace clic en un botón'},
  {fecha: '2021', title: 'Curso Python', descripcion: 'Creé un programa que permita gestionar tareas diarias'},
  {fecha: '2021', title: 'Curso Introducción a JavaScript, CSS y HTML', descripcion: 'Desarrollé una web básica para una inmobiliaria, implementando Inicio, Blog, Propiedades, Alquileres, Contacto y Ubicacion.'},
  {fecha: '2020', title: 'Curso de Arduino y Python 1, 2, 3', descripcion: 'Completé un curso presencial sobre armado de pagina web y robotica, donde aprendí lenguajes como Python y Arduino.'}
]);
</script>
...
ul::before {
  ...
  background: rgb(226, 226, 226); /* Color de la línea */
...
ul li .descripcion::before {
  ...
  background: rgba(19, 19, 20, 0.5); /* Color de fondo oscuro para simular una sombra */
